<template>
    <view class="more-share fadeIn animated" v-if="show">
        <view class="more-share-model" @tap="clickshow()"></view>
        <view class="more-share">
            <view class="more-share-title u-f-ajc">分享到</view>
            <scroll-view scroll-x class="more-share-body">
                <block v-for="(val,i) in providerList" :key="i">
            ...
            <view class="more-share-bottom u-f-ajc" @tap="clickshow">取消</view>
        </view>
    </view>
</template>
